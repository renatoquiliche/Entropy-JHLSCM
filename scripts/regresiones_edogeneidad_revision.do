...
global 	covariables i.comuna1 i.comuna2 i.comuna3 i.comuna4 i.comuna5 i.comuna6 i.comuna7 ///
		i.comuna8 i.comuna9 i.comuna10 i.comuna11 i.comuna12 i.comuna13 i.comuna14 i.comuna15 ///
		i.comuna16 i.comuna17 i.comuna18 i.comuna19 i.comuna20 i.comuna21 i.comuna22 i.comuna23
...
logit			riesg_deslizamiento d1_hat d2_hat ///
				$covariables i.riesg_inundacion i.riesg_colapso, cluster(com)
lroc
margins 		, dydx(*) atmeans post
outreg2 using results_logit_iv, excel dec(3) replace ctitle("Landslides")

*estat clas		
logit			riesg_inundacion d1_hat d2_hat ///
				$covariables i.riesg_deslizamiento i.riesg_colapso, cluster(com)
lroc
margins 		, dydx(*) atmeans post
outreg2 using results_logit_iv, excel dec(3) append ctitle("Floods")
*estat clas	
				
logit			riesg_colapso d1_hat d2_hat ///
				$covariables i.riesg_inundacion i.riesg_deslizamiento, cluster(com)
lroc
margins 		, dydx(*) atmeans post
outreg2 using results_logit_iv, excel dec(3) append ctitle("Collapses")				
*estat clas	
